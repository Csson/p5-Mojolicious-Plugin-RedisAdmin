...
define('app/startup',['exports', 'jquery', 'bootstrap', 'knockout', 'knockout-projections', './router'], function (exports, _jquery, _bootstrap, _knockout, _knockoutProjections, _router) {
    ...
    _ko['default'].bindingHandlers.clickBlur = {
        init: function init(el, valueAcc, allBindingsAcc, data, context) {
            var value = valueAcc();

            _ko['default'].utils.registerEventHandler(el, 'click', function () {
                $(el).blur();
            });
            _ko['default'].bindingHandlers.click.init(el, valueAcc, allBindingsAcc, data, context);
        }
    };

    // Components can be packaged as AMD modules, such as the following:
    _ko['default'].components.register('navbar', { require: 'components/navbar/navbar' });
    ...
    _ko['default'].components.register('redis-key-row', { require: 'components/redis/key-row' });

    _ko['default'].components.register('redis-table', { require: 'components/redis/table' });
...
//# sourceMappingURL=data:application/json;base64,;
/**
...
define('text!components/home-page/home.html',[],function () { return '<redis-table></redis-table>\n';});
...
define('components/home-page/home',['exports', 'module', 'knockout', 'text!./home.html'], function (exports, module, _knockout, _textHomeHtml) {
    ...
    var HomeViewModel = (function () {
        function HomeViewModel(route) {
            ...
            this.message = _ko['default'].observable('Welcome to Redisity!');
        }
...
//# sourceMappingURL=data:application/json;base64,;
define('text!components/redis/table.html',[],function () { return '\n            <div class="panel panel-default">\n            \n                <div class="panel-heading">\n                    <h3 class="panel-title">\n            <div class="btn-group pull-right">\n                \n                <div class="btn-group">\n                    \n            <a class="btn btn-primary dropdown-toggle" data-bind="clickBlur: function() {}" data-toggle="dropdown" href="#" type="button">New <span class="caret"></span></a>\n            <ul class="dropdown-menu">\n                <li ><a class="menuitem" href="#" tabindex="-1">Key</a></li><li ><a class="menuitem" href="#" tabindex="-1">Hash</a></li>\n            </ul>\n        \n                </div>\n            <a class="btn btn-primary" data-bind="clickBlur: scanDatabases" href="#">Scan</a>\n            </div>Keys</h3>\n                </div>\n            \n                \n            <table class="table table-condensed table-hover table-striped" class="table table-condensed table-hover table-striped">\n            \n    <thead>\n        <tr>\n            <th>Key</th>\n            <th style="width: 20%;">\n                <div class="btn-group">\n            <button class="btn btn-primary btn-xs dropdown-toggle" data-toggle="dropdown" type="button">TTL <span class="caret"></span></button>\n            <ul class="dropdown-menu">\n                <li class="dropdown-header">Toogle all</li><li ><a class="menuitem" href="#" tabindex="-1">On</a></li><li ><a class="menuitem" href="#" tabindex="-1">Off</a></li><li class="dropdown-header">Fetch TTL every</li><li ><a class="menuitem" href="#" tabindex="-1">2 seconds</a></li><li ><a class="menuitem" href="#" tabindex="-1">5 seconds</a></li><li ><a class="menuitem" href="#" tabindex="-1">10 seconds</a></li><li ><a class="menuitem" href="#" tabindex="-1">30 seconds</a></li><li ><a class="menuitem" href="#" tabindex="-1">1 minute</a></li>\n            </ul>\n        </div>              \n            </th>\n            <th style="width: 10%;">Actions</th>\n        </tr>\n    </thead>\n    <tbody data-bind="foreach: items()">\n        <tr>\n            <td class="clickable" data-bind="clickToggler: open, click: fetchValue, text: key"></td>\n            <td><a class="btn btn-default btn-sm" data-bind="clickToggler: fetch_ttl" data-toggle="button" href="#" style="outline: 0;">TTL</a>\n                <span data-bind="visible: fetch_ttl, text: ttl"></span>\n            </td>\n            <td><a class="btn btn-danger btn-sm glyphicon glyphicon-remove" data-bind="click: function() { $parent.removeKey($data) } " href="#"></a></td>\n        </tr>\n        <tr data-bind="visible: open">\n            <td colspan="3"><pre style="max-height: 300px; max-width: 1120px;" data-bind="text: keyValue"></pre></td>\n        </tr>\n    </tbody>\n\n            </table>\n        \n            </div>\n        \n';});

define('components/redis/table',['exports', 'module', 'knockout', 'text!./table.html'], function (exports, module, _knockout, _textTableHtml) {
    ...
    var _templateMarkup = _interopRequireDefault(_textTableHtml);

    var RedisTableItem = (function () {
        function RedisTableItem(params) {
            _classCallCheck(this, RedisTableItem);

            this.key = _ko['default'].observable(params.key);
            this.actual_key = _ko['default'].observable(params.actual_key);
            this.fetch_ttl = _ko['default'].observable(false);
            this.ttl = _ko['default'].observable();
            this.keyValue = _ko['default'].observable();
            this.open = _ko['default'].observable(false);
        }

        _createClass(RedisTableItem, [{
            key: 'fetchValue',
            value: function fetchValue() {
                ...
                if (this.open() && this.keyValue() === undefined) {
                    console.log('..really!');
                    $.get('/key/' + this.actual_key() + '/value', function (data) {
                        try {
        ...
        return RedisTableItem;
    })();

    var RedisTable = (function () {
        function RedisTable(params) {
            _classCallCheck(this, RedisTable);

            this._ttl_timer_seconds = 2;
            this.message = _ko['default'].observable('Hello from the redis/table component!');
            this.items = _ko['default'].observableArray([]);
            this.ttl_timer_interval = _ko['default'].observable(this._ttl_timer_seconds);
            this.ttl_timer = this.start_ttl();

            this.scanDatabases();
        }

        _createClass(RedisTable, [{
            key: 'scanDatabases',
            value: function scanDatabases() {
                var self = this;
            ...
            key: 'removeKey',
            value: function removeKey(item) {
                var self = this;
                $.post('/delete/key/' + item.actual_key(), function (data) {
                    if (data.result === 1) {
            ...
            key: 'fetchTTL',
            value: function fetchTTL(item) {
                item.fetch_ttl(true);
                console.log(item.fetch_ttl());
            }
        }, {
            key: 'start_ttl',
            value: function start_ttl() {
                var self = this;
                return setInterval(function () {
                    var newTimer = self.ttl_timer_interval() - 1;

                    if (newTimer <= 0) {
                        var want_ttl_keys = $.map($.grep(self.items(), function (item, i) {
                            return item.fetch_ttl();
                        }), function (item) {
                            ...
                            $.getJSON('/command/TTL', { keys: want_ttl_keys }, function (data) {
                                ...
                                for (var i = 0; i < keydata.length; i++) {
                                    var items = $.grep(self.items(), function (item) {
                                        return item.actual_key() === keydata[i]['key'];
                                    });
                                    if (items.length == 1) {
    ...
    module.exports = { viewModel: RedisTable, template: _templateMarkup['default'] };
});
//# sourceMappingURL=data:application/json;base64,;
require(["app/startup"]);
